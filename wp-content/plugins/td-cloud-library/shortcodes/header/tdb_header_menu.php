        ...
        <script>
            ...
            (function () {
                ...
                if ( jquery_object_container.length) {
                    ...
                    //console.log(blockMenu.css('display'));
                    ...
                    if ( blockMenu.css('display') !== undefined && blockMenu.css('display') === 'inline-block' ) {
                        ...
                        column.find( a + ' > .td_block_wrap' ).each( function (index,element) {
                            ...
                            //console.log(jQuery(this).data('td-block-uid'));
                            //console.log( 'percent: ' + percentOfColumnWidth);
                            //console.log( 'el_width: ' + elementWidth);

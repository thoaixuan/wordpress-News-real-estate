...
function pt_magazine_scripts() {
	...
	wp_enqueue_script( 'pt-magazine-custom', get_template_directory_uri() . '/assets/js/custom.js', array( 'jquery' ), '1.1.4', true );
...
function pt_magazine_admin_scripts( $hook ) {
	...
	if( 'widgets.php' === $hook ){
		...
		wp_enqueue_style( 'pt-magazine-admin', get_template_directory_uri() . '/includes/widgets/css/admin.css', array(), '1.1.4' );

		wp_enqueue_media();

		wp_enqueue_script( 'pt-magazine-admin', get_template_directory_uri() . '/includes/widgets/js/admin.js', array( 'jquery' ), '1.1.4' );
